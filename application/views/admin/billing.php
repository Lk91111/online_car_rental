    ...
    <div id="main" class="layout-column flex">
        ...
        <div id="content" class="flex">
            <!-- ############ Main START-->
            <div class="card-header" style="text-align: center; text-transform: uppercase; font-size: 26px;margin-top: 20px;"><strong>Billing Details</strong></div>
                                ...
                                <table class="table table-theme table-row v-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="v-middle" data-id="15">
                                            ...
                                            <td>
                                                <div class="avatar-group"><?=$value->fname?></div>
                                            </td>
                                            <td>
                                                <div class="avatar-group"><?=$value->lname?></div>
                                            </td>
                                           
                                            <td>
                                                <div class="avatar-group"><?=$value->country?></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="avatar-group"><?=$value->coupon?></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                 <div class="avatar-group">
                                                     <a href="<?=  base_url('admin/delete_bill')?>?q=<?=$value->id?>"><span class="nav-icon text-info">
