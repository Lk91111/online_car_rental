    ...
    <div id="main" class="layout-column flex">
        ...
        <div id="content" class="flex">
            <!-- ############ Main START-->
            <div class="card-header" style="text-align: center; text-transform: uppercase; font-size: 26px;margin-top: 20px;"><strong>All Reviews</strong></div>
                                        ...
                                        <tr class="v-middle" data-id="15">
                                            ...
                                            <td>
                                                 <div class="avatar-group">
                                                     <a href="<?=  base_url('admin/delete_review')?>?q=<?=$value->id?>"><span class="nav-icon text-info">
                                                                    <i data-feather="trash">

                                                                    </i>
                                                         </span></a>
                                                     
                                                     <a href="<?=  base_url('admin/tick_review')?>?q=<?=$value->id?>"><span class="nav-icon text-info">
