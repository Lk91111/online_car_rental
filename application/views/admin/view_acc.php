    ...
    <div id="main" class="layout-column flex">
        ...
        <div id="content" class="flex">
            <!-- ############ Main START-->
            <div class="card-header" style="text-align: center; text-transform: uppercase; font-size: 26px;margin-top: 20px;"><strong>Accessories Details</strong></div>
                                        ...
                                        <tr class="v-middle" data-id="15">
                                            ...
                                            <td>
                                                <div class="avatar-group">
                                                    <img src="<?=  base_url()?>assets/images/acc/<?=$values->img?>" style="height: 40px;width: 40px;border-radius: 50%;">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="avatar-group"><?=$values->name?></div>
                                            </td>
                                             <td>
                                                <div class="avatar-group"><?=$values->price?></div>
                                            </td>
                                            <td>
                                                <div class="avatar-group"><?=$values->com?></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                 <div class="avatar-group">
                                                     <a href="<?=  base_url('admin/delete_acc')?>?q=<?=$values->id?>"><span class="nav-icon text-info">
                                                                    <i data-feather="trash">

                                                                    </i>
                                                         </span></a>
                                                     
                                                     <a href="<?=  base_url('admin/edit_acc')?>?q=<?=$values->id?>"><span class="nav-icon text-info">
