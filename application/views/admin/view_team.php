    ...
    <div id="main" class="layout-column flex">
        ...
        <div id="content" class="flex">
            <!-- ############ Main START-->
            <div class="card-header" style="text-align: center; text-transform: uppercase; font-size: 26px;margin-top: 20px;"><strong>Team Details</strong></div>
                                        ...
                                        <tr class="v-middle" data-id="15">
                                            ...
                                            <td>
                                                <div class="avatar-group">
                                                    <img src="<?=  base_url()?>assets/images/team/<?=$value->img?>" style="height: 40px;width: 40px;border-radius: 50%;">
                                                </div>
                                            </td>
                                            <td>
                                             ...
                                             <td>
                                                <div class="avatar-group"><?=$value->uname?></div>
                                            </td>
                                             <td>
                                             ...
                                             <td>
                                                <div class="avatar-group"><?=$value->age?></div>
                                            </td>
                                            <td>
                                                <div class="avatar-group"><?=$value->post?></div>
                                            </td>
                                             <td>
                                                <div class="avatar-group"><?=$value->pwd?></div>
                                            </td>
                                             <td>
                                             ...
                                             <td>
                                                 <div class="avatar-group">
                                                     ...
                                                     <a href="<?=  base_url('admin/delete_team')?>?q=<?=$value->id?>"><span class="nav-icon text-info">
                                                                    <i data-feather="trash">

                                                                    </i>
                                                         </span></a>
                                                     <a href="<?=  base_url('admin/team')?>?q=<?=$value->id?>"><span class="nav-icon text-info">
                                                                    <i data-feather="eye">

                                                                    </i>
                                                     </span></a>
                                                     <a href="<?=  base_url('admin/edit_team')?>?q=<?=$value->id?>"><span class="nav-icon text-info">
